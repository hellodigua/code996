...
const commandOptions = [
  ...
  { command: '--web', descriptionKey: 'notices.options.web' },
  { command: '--web --no-open', descriptionKey: 'notices.options.noOpen' },
...
const commandRecipes = [
  ...
  { command: 'npx code996 --web', descriptionKey: 'notices.recipes.web' },
  { command: 'npx code996 "/path/to/repo" --web', descriptionKey: 'notices.recipes.repo' },
  { command: 'npx code996 -y 2025 --web', descriptionKey: 'notices.recipes.year' },
  { command: 'npx code996 --all-time --web', descriptionKey: 'notices.recipes.allTime' },
  { command: 'npx code996 --self -y 2025 --web', descriptionKey: 'notices.recipes.self' },
  { command: 'npx code996 --hours 9-18 -y 2025 --web', descriptionKey: 'notices.recipes.hours' },
  {
    command: 'npx code996 "/path/to/repo-a" "/path/to/repo-b" -y 2025 --web',
