...
│ 序号   │ 项目名称                │ 996指数    │ 等级描述                     │
├────────┼─────────────────────────┼────────────┼──────────────────────────────┤
│ 1      │ weapp-release-server    │ 78.0       │ 很差，接近996的程度          │
│ 2      │ dxy-doctor-weapp        │ 63.0       │ 较差，加班文化比较严重       │
│ 3      │ dxy-doctor-weapp-doctor │ 57.0       │ 较差，加班文化比较严重       │
└────────┴─────────────────────────┴────────────┴──────────────────────────────┘

统计信息:
  成功分析: 3 个仓库
  加班最严重: weapp-release-server (996指数: 78.0)
  工作最轻松: dxy-doctor-weapp-doctor (996指数: 57.0)
```
